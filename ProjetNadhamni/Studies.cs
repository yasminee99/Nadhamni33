        ...
        private void btnSaveStudies_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    con.Open();
                    SqlCommand cmd = new SqlCommand("insert into Studies(LevelOfStudies,Speciality,Establishment,DaysOfStud,StartTime,EndTime) values(@LevelOfStudies,@Speciality,@Establishment,@DaysOfStud,@StartTime,@EndTime)", con);

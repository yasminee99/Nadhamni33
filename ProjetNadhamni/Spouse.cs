    ...
    public partial class Spouse : Form
    {
        ...
        private void btnSaveSpouse_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                con.Open();
                SqlCommand cmd = new SqlCommand("insert into Spouse(FirstName,LastName,Gender,Birthday,Health,Consultation,DrName,Work,TypeOfWork,DaysOfWork) values(@FirstName,@LastName,@Gender,@Birthday,@Health,@Consultation,@DrName,@Work,@TypeOfWork,@DaysOfWork)", con);
